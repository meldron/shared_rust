...
RustBuffer normalizer_c9ab_normalize_username(
      RustBuffer s,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_normalizer_c9ab_rustbuffer_alloc(
      int32_t size,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_normalizer_c9ab_rustbuffer_from_bytes(
      ForeignBytes bytes,
    RustCallStatus *_Nonnull out_status
    );
void ffi_normalizer_c9ab_rustbuffer_free(
      RustBuffer buf,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_normalizer_c9ab_rustbuffer_reserve(
